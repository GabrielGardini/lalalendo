        ...
        GeometryReader { geometry in
            ZStack {
                ...
                ViewController(pages: [
                    ...
                    makeSimplePage(text: "O mico te mostra a floresta mágica. Tudo é muito bonito, tem flores e animais encantados! Você quer explorar tudo, mas vê seu amigo ao longe, bem triste porque seu cãozinho fugiu.", defaultImage: "macaco2", rightChoice: 3, leftChoice: 2, question: "Ficar com seu amigo ou explorar a floresta?", rightButtonImage: "macaco", rightButtonText: "macaco", leftButtonImage: "lala", leftButtonText: "lala", mainRightImage: "macaco", mainLeftImage: "lala"),
